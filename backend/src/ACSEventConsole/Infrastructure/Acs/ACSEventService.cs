...
using ACSEventConsole.Services;
...
namespace ACSEventConsole.Infrastructure.Acs
{
    ...
    class ACSEventService
    {
        ...
        private string ResolvePersonName(string employeeNo, string sNetUser)
        {
            ...
            {
                if (EmployeeNameRegistry.TryGetName(employeeNo, out string mappedName))
                {
                    return mappedName;
                }
                ...
                {
                    if (EmployeeNameRegistry.TryGetName(key, out string mappedKeyName))
                    {
